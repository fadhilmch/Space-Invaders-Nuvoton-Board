...
void init_PWM(uint8_t PWM_no, uint8_t CLKSRC_SEL, uint8_t PreScalar, uint8_t ClockDivider)
{  
  switch (PWM_no) {
	case 0 : 
	SYS->GPAMFP.PWM0_AD13=1;     // Enable PWM0 multi-function pin	
	SYSCLK->CLKSEL1.PWM01_S = CLKSRC_SEL; // Select 12Mhz for PWM clock source		
	SYSCLK->APBCLK.PWM01_EN =1;  // Enable PWM0 & PWM1 clock	
	PWMA->PPR.CP01=PreScalar;    // Prescaler 0~255, Setting 0 to stop output clock
	PWMA->CSR.CSR0=ClockDivider; // PWM clock = clock source/(Prescaler + 1)/divider
	...
	SYSCLK->APBCLK.PWM01_EN =1;  // Enable PWM0 & PWM1 clock	
	PWMA->PPR.CP01=PreScalar;    // Prescaler 0~255, Setting 0 to stop output clock
	PWMA->CSR.CSR1=ClockDivider; // PWM clock = clock source/(Prescaler + 1)/divider
	...
	SYSCLK->CLKSEL1.PWM23_S = CLKSRC_SEL; // Select 12Mhz for PWM clock source		
	SYSCLK->APBCLK.PWM23_EN =1;  // Enable PWM2 & PWM3 clock	
	PWMA->PPR.CP23=PreScalar;    // Prescaler 0~255, Setting 0 to stop output clock
	PWMA->CSR.CSR2=ClockDivider; // PWM clock = clock source/(Prescaler + 1)/divider
	...
	SYSCLK->APBCLK.PWM23_EN =1;  // Enable PWM2 & PWM3 clock	
	PWMA->PPR.CP23=PreScalar;  // Prescaler 0~255, Setting 0 to stop output clock
	PWMA->CSR.CSR3=ClockDivider;  // PWM clock = clock source/(Prescaler + 1)/divider
	...
	break;  
	case 4 : 
	SYS->GPBMFP.TM3_PWM4=1; // Enable PWM0 multi-function pin	
	SYSCLK->CLKSEL2.PWM45_S = CLKSRC_SEL; // Select 12Mhz for PWM clock source		
	SYSCLK->APBCLK.PWM45_EN =1;  // Enable PWM0 & PWM1 clock	
	PWMB->PPR.CP01=PreScalar;    // Prescaler 0~255, Setting 0 to stop output clock
	PWMB->CSR.CSR0=ClockDivider; // PWM clock = clock source/(Prescaler + 1)/divider
	...
	break; 
	case 5 : 
	SYS->GPEMFP.PWM5=1; // Enable PWM5 multi-function pin
	SYSCLK->APBCLK.PWM45_EN = 1; // Enable PWM45 clock
	SYSCLK->CLKSEL2.PWM45_S = CLKSRC_SEL; // Select 12Mhz for PWM clock source		
	SYSCLK->APBCLK.PWM45_EN =1;  // Enable PWM4 & PWM5 clock	
	PWMB->PPR.CP01=PreScalar;    // Prescaler 0~255, Setting 0 to stop output clock
	PWMB->CSR.CSR1=ClockDivider; // PWM clock = clock source/(Prescaler + 1)/divider
	...
	break;
	case 6 : 
	SYS->GPEMFP.PWM6=1;// Enable PWM2 multi-function pin
	SYSCLK->CLKSEL2.PWM67_S = CLKSRC_SEL; // Select 12Mhz for PWM clock source		
	SYSCLK->APBCLK.PWM67_EN =1;  // Enable PWM2 & PWM3 clock	
	PWMB->PPR.CP23=PreScalar;    // Prescaler 0~255, Setting 0 to stop output clock
	PWMB->CSR.CSR2=ClockDivider; // PWM clock = clock source/(Prescaler + 1)/divider
	...
	break;							 
	case 7 : 
	SYS->GPEMFP.PWM7=1;// Enable PWM3 multi-function pin
	SYSCLK->CLKSEL2.PWM67_S = CLKSRC_SEL; // Select 12Mhz for PWM clock source		
	SYSCLK->APBCLK.PWM67_EN =1;  // Enable PWM2 & PWM3 clock	
	PWMB->PPR.CP23=PreScalar;	   // Prescaler 0~255, Setting 0 to stop output clock
	PWMB->CSR.CSR3=ClockDivider; // PWM clock = clock source/(Prescaler + 1)/divider
...
// PWM_Width_clkcount : for CNR register
// PWM_Hi_clkcount    : for CMR register
